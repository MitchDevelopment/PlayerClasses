package net.cubblesfakemythric.playerclasses.utils;
...
public class JsonBuilder {
    ...
    public void sendJson(Player p) {
        ((CraftPlayer) p).getHandle().playerConnection.sendPacket(new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a(toString())));
    }
